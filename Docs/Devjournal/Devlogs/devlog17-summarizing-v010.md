...
Следующий *крупный* этап - разработка версии ***v0.2.0*** - МК-версии нашего ПО с реальными сенсорами (драйверами), сетевым стеком (*LoRaWAN*), системой реального времени, *EEPROM*-персистентностью, суточным планировщиком и др. Этому этапу будут посвящены отдельные девлоги, будут отдельно сформированы требования и проч.
